...
<main>
  ...
  Exodus, Paul's missionary journeys &mdash; can show arrow overlays of the journey.</p>
  ...
  <div class="mapx-layout" id="map-explorer" data-mapstyle="topo">
    <aside class="mapx-rail">
      ...
      <label class="mapx-labels" id="mapx-journeys-toggle" hidden><input type="checkbox" id="mapx-journeys"> Show journey arrows</label>
    </aside>
